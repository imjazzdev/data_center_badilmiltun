...
class _CutiPegawaiYangSedangRatgasState
  ...
  List<UserRatgas> list_user_ratgas = [];
  Repository repository = Repository();

  getData() async {
    list_user_ratgas = await repository.getPegawaiRatgas();
  }
  ...
  Widget build(BuildContext context) {
    print(list_user_ratgas);
    return Scaffold(
        appBar: AppBar(
          title: Text('Pegawai yang sedang ratgas'),
        ),
        body: list_user_ratgas.isNotEmpty
            ? ListView.builder(
                      ...
                      Container(
                        child: Column(
                          ...
                          children: [
                            ...
                            Flexible(
                              child: Text(
                                  list_user_ratgas[index]
                                      .tanggal_pelaksanaan_ratgas,
                            ...
                            Flexible(
                              child: Container(
                                ...
                                child: Text(
                                    list_user_ratgas[index].jenis_ratgas,
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
